            ...
            <div class="row product-details">
                ...
                <div class="col-lg-6">
                    <div class="product-details-content">
                        <h5 class="product-details-collection">{{ $product->code }}</h5>
                        ...
                        <div class="product-details-action">
                            ...
                            <div class="product-details-cart-wishlist">
                                ...
                                <button type="button" class="btn" id="add_to_cart" data-product-id="{{ $product->id }}" data-bs-toggle="modal" data-bs-target="#action-CartAddModal">Add to cart</button>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="tab-content" id="product-details-nav-tabContent">
                        ...
                        <div class="tab-pane fade show active" id="review" role="tabpanel" aria-labelledby="review-tab">
                            ...
                            <div class="product-review-item product-review-reply">
                                <div class="product-review-top">
                                    <div class="product-review-thumb">
                                        <img src="{{ asset('assets/images/shop/product-details/comment2.webp') }}" alt="Images">
                                    </div>
                                    <div class="product-review-content">
                                        <span class="product-review-name">Tomas Doe</span>
                                        <span class="product-review-designation">Delveloper</span>
                            ...
                            <div class="product-review-item mb-0">
                                <div class="product-review-top">
                                    <div class="product-review-thumb">
                                        <img src="{{ asset('assets/images/shop/product-details/comment3.webp') }}" alt="Images">
                                    </div>
                                    <div class="product-review-content">
                                        <span class="product-review-name">Tomas Doe</span>
                                        <span class="product-review-designation">Delveloper</span>
